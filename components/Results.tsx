                ...
                {clusters.map((cluster) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex-shrink-0 rounded-full bg-gradient-to-br ${colors[colorIndex]} shadow-lg hover:shadow-2xl transform transition-all duration-300 hover:scale-110 cursor-pointer group ${
